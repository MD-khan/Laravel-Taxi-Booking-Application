 ...
 <span> <a href="#"> {{ config('app.name') }}</a></span>
    ...
    <tr>
        <td style="font-family:arial,verdana,sans-serif;font-size:14px;padding:0 25px;line-height:17px;color:#414140;">
            ...
            <p>
            Thank you for using {{ config('app.name') }}. We appreciate your business!      </p>

        <p>
        
        We will notify you by email about your driver. If you want to change booking information,  visit <a href="#"> {{ config('app.name') }}</a>
       </p> 
        </td>
    </tr>
    ...
    <td bgcolor="#f5f2f0" style="font-size:14px;font-family:arial,verdana,sans-serif;color:#414141;padding:20px 25px 15px">
        ...
        <div style="float:left;clear:left;font-weight:bold;font-size:14px;width:12em;padding-bottom:10px">Pick-Up address:</div>
...
<div style="padding-bottom:7px">Time -   {{$time}}<br></div>
            ...
            <div style="float:left;clear:left;font-weight:bold;font-size:14px;width:12em;padding-bottom:10px">Your Total:</div>
            <div style="float:left;padding:0 0 20px 15px;
            min-width:35%;color:#469c23">
