      ...
      <div class="panel panel-primary"> 
        <div class="panel-heading"> Check out </div>
         <div class="panel-body"> 
          <p> You are going to chec out as a guest</p>
          <a class="btn btn-warning" href="/passanger/login"> 
           You can also check out as an existing member: <strong>Login</strong>
          </a>
         </div>
      </div>
      <div class="panel panel-primary"> 
        ...
        @include('layouts.errors')
         <div class="panel-body"> 
        <form action="/guest/checkout" method="POST" id="payment-form">
           {{ csrf_field() }}
        <div class="row">
          <div class="col-sm-6"> 
          <div class="form-group">
            ...
            value="{{Auth::guard('passanger')->check() ? Auth::guard('passanger')->user()->firstName : '' }}" required="">
          </div>
          </div>
          ...
          <div class="col-sm-6">
            <div class="form-group">
              ...
              <input type="text" name="lastName" id="lastName" class="form-control" 
                value="{{Auth::guard('passanger')->check() ? Auth::guard('passanger')->user()->lastName : '' }}" required="">
            </div>
           </div>
       </div>
       ...
       <div class="form-group">
          ...
          value="{{Auth::guard('passanger')->check() ? Auth::guard('passanger')->user()->email : '' }}" required="">
      </div>
